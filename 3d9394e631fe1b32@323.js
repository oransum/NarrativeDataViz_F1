// https://observablehq.com/d/3d9394e631fe1b32@323
export default function define(runtime, observer) {
  const main = runtime.module();
  const fileAttachments = new Map([["f1_dr_cons_relation_rename@2",new URL("./files/cdc1e7329ebb6a051dbbc82e16c51883729950a59cf4f62e29b5607a6a4677a8eafe2d9f64770791d3898ebbb31641f734bfd52bcaf26681839bda30b8e0c2ff",import.meta.url)]]);
...
{top: 20, right: 20, bottom: 20, left: 170}
)});
...
FileAttachment("f1_dr_cons_relation_rename@2").json()
)});
